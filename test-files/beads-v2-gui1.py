...
class Ui_Foram_GUI_proto(object):
    ...
    def setupUi(self, Foram_GUI_proto):
        ...
        self.label.setGeometry(QtCore.QRect(10, 10, 585, 585))
    ...
    def update(self):
        self.img = np.array(get_image())
        frame = cv2.resize(self.img, (585, 585))
        frame = frame >> 4
        frame = cv2.cvtColor(frame, cv2.COLOR_GRAY2RGB)
        print(frame.shape)

        height, width, foo = frame.shape
        bytes_per_line = frame.strides[0]
        self.image = QImage(frame, width, height, bytes_per_line, QImage.Format_RGB888)
